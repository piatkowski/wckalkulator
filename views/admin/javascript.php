...
<div class="javascript">
    <p>
        <?php _e('Use JavaScript or jQuery syntax. Use <code>wck("field_name")</code> to access jQuery object of the field by its name. You can use <code>jQuery()</code> or <code>$()</code>', 'wc-kalkulator'); ?>
    </p>
