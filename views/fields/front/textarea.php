...
<tr class="<?php echo esc_html($view->css_class); ?>">
    ...
    <?php echo wp_kses_post(apply_filters('wck_field_td', '<td class="value">', $view->field_type)); ?>
        <textarea id="<?php echo esc_html($view->id); ?>" class="attached enabled"
                  name="<?php echo esc_html($view->name); ?>"
                  placeholder="<?php echo esc_html($view->placeholder); ?>"
                  minlength="<?php echo absint($view->min_length); ?>"
                  maxlength="<?php echo absint($view->max_length); ?>"<?php echo esc_html($view->required); ?>><?php echo esc_html($view->value); ?></textarea>
    </td>
</tr>